...
public class App 
{
    public static void main( String[] args )
    {
        ...
        while (!quit){
            System.out.println("Welcome to the garbage classification game, please select the level you would want to play");
            ...
            System.out.println();
            System.out.println("Thank you for plating! do you like to go again?");
